import { Bell, Menu, Mic, Search, User, VideoIcon, Moon, Sun, Settings, Phone } from "lucide-react";
          ...
          <>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent className="w-56" align="end" forceMount>
                ...
                <DropdownMenuSeparator />
                <DropdownMenuItem asChild>
                  <Link href="/theme-settings">Theme Settings</Link>
                </DropdownMenuItem>
                <DropdownMenuItem asChild>
                  <Link href="/friends">VoIP & Calls</Link>
                </DropdownMenuItem>
                <DropdownMenuSeparator />
